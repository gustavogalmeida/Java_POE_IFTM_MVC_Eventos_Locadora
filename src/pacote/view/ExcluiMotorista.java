 ...
 */
public class ExcluiMotorista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Excluir motoristas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExcluiMotorista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExcluiMotorista().setVisible(true);
            }
        });
    }
