 ...
 */
public class ExcluiCacamba extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Excluir Caçamba");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExcluiCacamba.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExcluiCacamba().setVisible(true);
            }
        });
    }
